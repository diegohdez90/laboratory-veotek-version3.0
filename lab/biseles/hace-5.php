			...
			<script type="text/javascript">
				...
				function drawChart5() {
					var data = google.visualization.arrayToDataTable([
						...
						['Jorge',     <?php
									include('../connection.php');
		      						$queEmp = "SELECT count(*) as numero  FROM pedido where fecha='$sdatef' and tecnico='Jorge'";
		    						$resEmp = mysql_query($queEmp, $con) or die(mysql_error());
		    						$totEmp = mysql_num_rows($resEmp);
									 while ($rowEmp = mysql_fetch_assoc($resEmp)) {
									  echo $rowEmp['numero'];
						...
						['Victor',     <?php
									include('../connection.php');
		      						$queEmp = "SELECT count(*) as numero  FROM pedido where fecha='$sdatef' and tecnico='Victor'";
		    						$resEmp = mysql_query($queEmp, $con) or die(mysql_error());
		    						$totEmp = mysql_num_rows($resEmp);
									 while ($rowEmp = mysql_fetch_assoc($resEmp)) {
									  echo $rowEmp['numero'];
