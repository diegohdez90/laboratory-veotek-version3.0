			...
			<script type="text/javascript">
				...
				function drawChart4() {
					var data = google.visualization.arrayToDataTable([
						...
						['Jorge',     <?php
									include('../connection.php');
		      						$queEmp = "SELECT count(*) as numero  FROM pedido where fecha='$sdatee' and tecnico='Jorge'";
		    						$resEmp = mysql_query($queEmp, $con) or die(mysql_error());
		    						$totEmp = mysql_num_rows($resEmp);
									 while ($rowEmp = mysql_fetch_assoc($resEmp)) {
									  echo $rowEmp['numero'];
						...
						['Victor',     <?php
									include('../connection.php');
		      						$queEmp = "SELECT count(*) as numero  FROM pedido where fecha='$sdatee' and tecnico='Victor'";
		    						$resEmp = mysql_query($queEmp, $con) or die(mysql_error());
		    						$totEmp = mysql_num_rows($resEmp);
									 while ($rowEmp = mysql_fetch_assoc($resEmp)) {
									  echo $rowEmp['numero'];
