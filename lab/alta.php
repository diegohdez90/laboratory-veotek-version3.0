...
?>
		...
		<div class="row">
			<div class="col-md-8 alta">
				...
				<form onsubmit="return verify_code();" action="registrar-entrada.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<input class="form-control" type="number" id="canti" name="canti">
					</div>
	                <div class="form-group">
					...
					<div class="form-group">
						<label><b>Clave de acceso</b> </label>
