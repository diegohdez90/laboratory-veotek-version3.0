			...
			<div class="col-md-4 menu">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<ul>
							<li>
								<p class="text-center"><a href="../modificar.php"><span class="glyphicon glyphicon-login" style="font-size:44px;"></span></a><br>
		                        Entradas</p>
							</li>
							<li>
